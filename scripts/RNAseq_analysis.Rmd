...
### Align ETV6 smps
```{r Align ETV6 smps, echo=TRUE, results='hide', eval=FALSE}
...
### Align kinase smps
```{r Align kinase smps, echo=TRUE, results='hide', eval=FALSE}
...
```{r Resolving sample IDs, echo=TRUE, results='hide', eval=FALSE}
...
### Downstream analysis  
```{r Downstream analysis, echo=TRUE}
# Load & Prepare Data  -----
library(DESeq2)
library(sva)
library(dplyr)
